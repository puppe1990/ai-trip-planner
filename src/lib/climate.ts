...
export function getDestinationClimate(destination: string): ClimateProfile {
  ...
  if (
    ...
    dest.includes('lap') ||
    dest.includes('islând') ||
    dest.includes('noruega') ||
    dest.includes('finlând') ||
    dest.includes('canadá') ||
    dest.includes('alpes') ||
    dest.includes('chamonix') ||
    dest.includes('aspen') ||
    dest.includes('siberia') ||
    dest.includes('patagônia') ||
    dest.includes('ushuaia') ||
    dest.includes('himalaia') ||
    dest.includes('alaska') ||
    dest.includes('alasca')
  ) {
    return {
      ...
      months: [
        ...
        },
        {
          ...
          precip: 60,
          sunHours: 4,
          recommendation: 'Frio e neve: Casacos de pluma grossos, meias térmicas e botas com antiderrapante.',
        },
        {
          month: 'Mar',
          tempMax: 6,
          ...
          precip: 70,
          sunHours: 5,
          recommendation: 'Transição fria: Jaquetas acolchoadas, calçados resistentes e blusas de lã grossa.',
        },
        {
          month: 'Abr',
          tempMax: 11,
          ...
          precip: 75,
          sunHours: 6,
          recommendation: 'Fresco e instável: Capa de chuva leve, jaqueta corta-vento e sapatos fechados impermeáveis.',
        },
        {
          month: 'Mai',
          tempMax: 15,
          ...
          precip: 90,
          sunHours: 7,
          recommendation: 'Agradável com chuva: Suéteres leves, lenços, e sapatos confortáveis para caminhar.',
        },
        {
          month: 'Jun',
          tempMax: 19,
          ...
          precip: 100,
          sunHours: 8,
          recommendation: 'Verão ameno: Roupas leves para o dia e cardigan/jaqueta leve para o entardecer.',
        },
        {
          month: 'Jul',
          tempMax: 22,
        ...
        },
        {
          ...
          precip: 85,
          sunHours: 6,
          recommendation: 'Fresco de outono: Jaqueta leve ou suéter aconchegante, calças jeans e botas.',
        },
        {
          month: 'Out',
          tempMax: 12,
          ...
          precip: 75,
          sunHours: 4,
          recommendation: 'Frio moderado: Casaco corta-vento de outono, cachecol leve e sapatos totalmente fechados.',
        },
        {
          month: 'Nov',
          tempMax: 6,
          ...
          precip: 70,
          sunHours: 3,
          recommendation: 'Frio acentuado: Sobretudo ou jaqueta invernal pesada, luvas finas e golas altas.',
        },
        {
          month: 'Dez',
          tempMax: 2,
          ...
          precip: 65,
          sunHours: 2,
          recommendation: 'Inverno rigoroso de neve: Proteção total contra congelamento. Segunda pele é indispensável.',
        },
      ],
    };
  }
  ...
  if (
    dest.includes('rio de janeiro') ||
    dest.includes('copacabana') ||
    dest.includes('bahia') ||
    dest.includes('nordeste') ||
    dest.includes('praia') ||
    dest.includes('beach') ||
    dest.includes('cancún') ||
    dest.includes('caribe') ||
    dest.includes('maldivas') ||
    dest.includes('miami') ||
    dest.includes('hawaii') ||
    dest.includes('havaí') ||
    dest.includes('tailândia') ||
    dest.includes('phuket') ||
    dest.includes('bali') ||
    dest.includes('ceará') ||
    dest.includes('recife') ||
    dest.includes('salvador') ||
    dest.includes('porto de galinhas') ||
    dest.includes('natal') ||
    dest.includes('jericoacoara') ||
    dest.includes('maragogi') ||
    dest.includes('fernando de noronha') ||
    dest.includes('caravelas') ||
    dest.includes('ibiza') ||
    dest.includes('grécia') ||
    dest.includes('santorini') ||
    dest.includes('amazon') ||
    dest.includes('manaus') ||
    dest.includes('pantanal')
  ) {
    return {
      ...
      months: [
        ...
        },
        {
          ...
          precip: 60,
          sunHours: 7,
          recommendation: 'Calor de volta: Vestidos leves, shorts curtos, sandálias anatômicas e chapéu de praia.',
        },
        {
          month: 'Nov',
          tempMax: 30,
  ...
  if (
    ...
    dest.includes('cairo') ||
    dest.includes('dubai') ||
    dest.includes('emirados') ||
    dest.includes('saara') ||
    dest.includes('atacama') ||
    dest.includes('arizona') ||
    dest.includes('las vegas') ||
    dest.includes('marrocos') ||
    dest.includes('marrakech') ||
    dest.includes('petra') ||
    dest.includes('jordânia') ||
    dest.includes('machu picchu') ||
    dest.includes('lima') ||
    dest.includes('texas') ||
    dest.includes('utah') ||
    dest.includes('grand canyon')
  ) {
    return {
      ...
      months: [
        ...
        },
        {
          ...
          precip: 1,
          sunHours: 11,
          recommendation: 'Aquecimento extremo: Proteções com manga longa anti-UV e garrafas térmicas com gelo.',
        },
        {
          month: 'Jun',
          tempMax: 39,
        ...
        },
        {
          ...
          precip: 0,
          sunHours: 11,
          recommendation: 'Extremo calor: Planeje passeios em locais com ar-condicionado. Use filtro solar FPS 60.',
        },
        {
          month: 'Set',
          tempMax: 36,
        ...
        },
        {
          ...
          precip: 3,
          sunHours: 8,
          recommendation: 'Clima super ameno: Ideal para turismo arqueológico. Traga moletom ou blazer para as noites.',
        },
        {
          month: 'Dez',
          tempMax: 20,
  ...
  const isSouthernHemisphere =
    dest.includes('são paulo') ||
    dest.includes('buenos aires') ||
    dest.includes('santiago') ||
    dest.includes('curitiba') ||
    dest.includes('gramado') ||
    dest.includes('porto alegre') ||
    dest.includes('florianópolis') ||
    dest.includes('sul') ||
    dest.includes('austrália') ||
    dest.includes('sidney') ||
    dest.includes('melbourne') ||
    dest.includes('áfrica do sul') ||
    dest.includes('montevid') ||
    dest.includes('bariloche');
    ...
    return {
      ...
      months: [
        ...
        },
        {
          ...
          precip: 80,
          sunHours: 7,
          recommendation: 'Alta umidade/Calor: Roupas frescas de algodão, óculos de sol e protetor solar frequente.',
        },
        {
          month: 'Mar',
          tempMax: 28,
  ...
  return {
    ...
    months: [
      ...
      },
      {
        ...
        precip: 55,
        sunHours: 9,
        recommendation: 'Sol abundante e quente: Use protetor solar facial, boné, vestidos soltos e óculos escuros.',
      },
      {
        month: 'Ago',
        tempMax: 27,
